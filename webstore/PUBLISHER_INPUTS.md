...
These values cannot be inferred safely and must be set by the publisher:
...
If GitHub Pages is the chosen host, the repository owner must enable Pages. The repository is public; no visibility change is required.
